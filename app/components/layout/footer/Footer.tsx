...
import { SheetDemo } from "@/components/Subscribe";
export default function Footer() {
	return (
		<footer aria-label="Site Footer" className="bg-background">
			<div className="mx-auto max-w-screen-xl space-y-8 px-4 py-16 sm:px-6 lg:space-y-8 lg:px-0">
				<div className="grid grid-cols-1 gap-2 lg:grid-cols-3">
					...
					<div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:col-span-2 lg:grid-cols-4">
						...
						<div>
							<p className="font-medium text-foreground ">Stay In Touch</p>
							<div className="mt-6 flex flex-shrink items-center space-x-4">
								<SheetDemo />
							</div>
						</div>
					</div>
